...
from rt.tasks import forecast_tasks, generate_plurel_tasks
...
if __name__ == "__main__":
    ...
    for num_train_dbs in [8, 16, 32, 64, 128, 256, 512, 1024]:
        plurel_tasks = generate_plurel_tasks(
            offset=offset,
            num_dbs=num_dbs,
            num_train_dbs=num_train_dbs,
            num_test_dbs=num_test_dbs,
        )
        syn_autocomplete_clf_tasks = plurel_tasks["train_autocomplete_clf_tasks"]
        syn_autocomplete_reg_tasks = plurel_tasks["train_autocomplete_reg_tasks"]
        ...
        eval_tasks += plurel_tasks["test_autocomplete_clf_tasks"]
        eval_tasks += plurel_tasks["test_autocomplete_reg_tasks"]
